        ...
        <div className="dashboard-content-area">
            ...
            <div className="risk-matrix">
                <div className="matrix-container" style={{ height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <em style={{ color: 'var(--gray-600)' }}>(Risk Matrix Visualization Area)</em>
                </div>
            </div>
    ...
    const rightPanel = (
        <div className="dashboard-action-panel">
            ...
            <div className="alert-banner" style={{ background: 'var(--red)', marginBottom: '1rem' }}>
                ...
                <div>
                    <strong style={{ display: 'block', fontSize: '1rem', marginBottom: '0.25rem' }}>Critical EOL</strong>
                    <span style={{ fontSize: '0.85rem' }}>2 servers reaching EOL next month</span>
                </div>
            </div>
            ...
            <div className="alert-banner warning">
                ...
                <div>
                    <strong style={{ display: 'block', fontSize: '1rem', marginBottom: '0.25rem' }}>Scheduled Patching</strong>
                    <span style={{ fontSize: '0.85rem' }}>3 patches scheduled for this weekend</span>
                </div>
            </div>
        </div>
    );
