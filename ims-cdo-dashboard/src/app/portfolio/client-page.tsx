...
import { Initiative, InitiativeType, InitiativeStage } from "@/lib/mock-data";
import {
    Table,
    TableBody,
    TableCell,
...
export default function PortfolioClientPage({ initialData }: { initialData: any }) {
    const [searchTerm, setSearchTerm] = useState("");
    const [typeFilter, setTypeFilter] = useState<string>("all");
    const [selectedInitiative, setSelectedInitiative] = useState<Initiative | null>(null);

    const filteredData = initialData.initiatives.filter((item: Initiative) => {
